 ...
 * @Last Modified time: 2018-09-08 10:14:29
 * 
 * 验收详情
 */
...
import { NavBar, Icon, WhiteSpace, List, Accordion } from 'antd-mobile';
import { connect } from 'dva';

const Item = List.Item;


class GroundingDetail extends PureComponent {
  state = {
    detailsData: {},
    amount: 0, // 添加批次
  ...
  render() {
    const { index, detailsData, disabled } = this.state;
...
export default connect(state => state)(GroundingDetail) ;
